...
def compute_cost(X, y, w, b, *argv):
    ...
    Returns:
      total_cost : (scalar) total logistic regression cost
    """
    m, n = X.shape
    total_cost = 0.0
...
def predict(X, w, b): 
    ...
    Returns:
      p : (ndarray Shape (m,))  predictions (0 or 1) for each example
    """
    m, n = X.shape   
    p = np.zeros(m)
...
def compute_cost_reg(X, y, w, b, lambda_ = 1):
    ...
    # Compute L2 regularization cost (exclude bias term)
...
def compute_gradient_reg(X, y, w, b, lambda_ = 1): 
    ...
    # Get base gradients without regularization
