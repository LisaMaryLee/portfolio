...
```
    ...
    np.zeros(4,) :  a = [0. 0. 0. 0.], a shape = (4,), a data type = float64
    np.random.random_sample(4): a = [0.26643288 0.67315164 0.77186264 0.38408507], a shape = (4,), a data type = float64
...
```
    ...
    np.random.rand(4): a = [0.41893013 0.06689179 0.53311892 0.32330951], a shape = (4,), a data type = float64
...
```
    ...
    Vectorized version duration: 157.6710 ms 
    my_dot(a, b) =  2501072.5817
    loop version duration: 11631.0859 ms 
